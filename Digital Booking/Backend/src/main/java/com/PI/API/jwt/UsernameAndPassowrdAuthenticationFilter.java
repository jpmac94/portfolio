...
public class UsernameAndPassowrdAuthenticationFilter extends UsernamePasswordAuthenticationFilter {

    private final AuthenticationManager authenticationManager;

    public UsernameAndPassowrdAuthenticationFilter(AuthenticationManager authenticationManager) {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
       ...
       String key="F2fnbdZk5xhL2jk5JhhUGqqJJ8nSr8L2jk5JJJ8nSr";
