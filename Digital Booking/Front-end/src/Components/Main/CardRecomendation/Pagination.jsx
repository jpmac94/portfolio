...
export default function Pagination({ pagina, setPagina, maximo }) {
  ...
  return (
    <div className="container-paginacion">
      <button className='paginacion-button' disabled={pagina === 1 || pagina < 1} onClick={previousPage}>
        <svg classname="svg"
          width="10"
          height="10" viewBox="0 0 20 27" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      />
      <p className='lett'> of </p>
      <p className='max-num'> {maximo}  </p>
